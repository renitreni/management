...
class PurchaseInfoController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('inventory::purchase_form', compact('purchase_info','product_details','summary'));
    }

    public function show($id)
    {
        $purchase_info = PurchaseInfo::find($id);
        $product_details = ProductDetail::query()->where('purchase_info_id', $id)->get();
        $summary = Summary::query()->where('purchase_detail_id', $id)->get()[0];
    ...
    public function update(Request $request)
    {
        ...
        DB::table('summaries')->where('purchase_detail_id', $data['overview']['id'])->delete();
        $data['summary']['purchase_detail_id'] = $data['overview']['id'];
    ...
    public function destory(Request $request)
    {
        ...
        DB::table('summaries')->where('purchase_detail_id', $request->id)->delete();
